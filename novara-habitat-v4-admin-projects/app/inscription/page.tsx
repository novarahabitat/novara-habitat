  ...
  return (
    <main className="min-h-screen bg-[#070707] text-white">
      ...
      <section className="mx-auto flex min-h-screen max-w-5xl flex-col justify-center px-6 pt-24">
        ...
        <h1 className="mt-5 text-5xl font-semibold">Création de compte</h1>
        <p className="mt-6 max-w-2xl text-lg leading-8 text-white/70">Création de compte client bientôt connectée à Supabase.</p>
