...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#070707] text-white">
      ...
      <section className="hero flex min-h-screen items-center px-6 pt-28">
        <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1fr_460px]">
          <div>
            ...
            <h1 className="max-w-4xl text-5xl font-semibold leading-[1.02] tracking-[-0.04em] md:text-7xl">
              L’Operating System premium de l’habitat.
            </h1>

            <p className="mt-8 max-w-2xl text-lg leading-8 text-white/68">
              Rénovation, mémoire numérique du bien, Core terrain, Sales
              commercial et fondations NOVARA SMART.
            </p>

            <div className="mt-11 flex flex-wrap gap-4">
              <a
                href="#contact"
                className="rounded-full bg-[#c9a45c] px-8 py-4 font-medium text-black shadow-[0_0_35px_rgba(201,164,92,0.22)] transition hover:bg-white"
              >
                Demander un devis
              </a>
          ...
          <div className="glass gold-glow rounded-[2.2rem] p-8">
            <div className="rounded-[1.8rem] border border-white/10 bg-black/35 p-8">
              <img
                src="/logos/novara-habitat.jpg"
                className="mx-auto h-52 w-52 object-contain drop-shadow-[0_0_35px_rgba(201,164,92,0.35)]"
                alt="NOVARA Habitat"
              />
              ...
              <div className="mt-8 rounded-3xl border border-white/10 bg-white/[0.06] p-6">
                ...
                <p className="mt-3 text-sm leading-6 text-white/50">
                  Première base visible de la mémoire numérique du bien.
                </p>
              </div>
            </div>
          </div>
      ...
      <section
        id="contact"
        className="bg-[#f5f0e8] px-6 py-24 text-black"
      >
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1fr_520px]">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-black/60">
              Votre demande arrive directement dans NOVARA Sales.
            </p>
          </div>
          ...
          >
            ...
            <textarea
              className="mt-4 min-h-32 w-full rounded-xl border border-black/10 px-4 py-3"
              placeholder="Message"
              value={message}
