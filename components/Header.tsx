  ...
  return (
    <header className="fixed top-0 z-50 w-full border-b border-white/10 bg-black/35 backdrop-blur-2xl">
      ...
      <div className="mx-auto flex h-24 max-w-7xl items-center justify-between px-6">
        ...
        <button className="rounded-full border border-[#c9a45c]/45 px-7 py-3 text-sm font-medium text-[#c9a45c] transition hover:bg-[#c9a45c] hover:text-black">
          Accès
        </button>
